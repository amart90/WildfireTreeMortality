##############################################################
#   Wildfire tree mortality detection and prediction using   #
#                     LiDAR and Landsat                      #
...
# dNBR(corr)
if(FALSE){ # Do not need corrected dNBR
  # Mode calculation i
...
# Stop script to identify with "Ground truthing" methods
stop("Visually identify areas of 100% mortality at point locations at this time")

# Import random sample points
...
# Create Random Forest from most important variables (rfm3)
...
# Export Burn prediction as jpeg
par(mar=c(1,1,1,1))
...
# Export LiDAR Prediction as jpeg
par(mar=c(1,1,1,1))
